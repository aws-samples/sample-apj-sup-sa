...
- Your completed canvas (a photo of the paper version, or a filled-in copy).
...
Copy everything in the block below into your coding agent, with your completed canvas
attached or pasted where indicated.
